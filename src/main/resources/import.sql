...
insert into users (username, password, first_name, last_name, email, role_id, location_id, is_activated, last_password_reset_date) values ('marko123', '$2a$10$llkMryD7KBQc1EkOeBdRO.5lcyVR3TEGqXh4G.JadCBu3mdfS44Y.', 'Marko', 'Marković', 'marko@email.com', 2, 1, true, '2024-11-07 11:30:00');
insert into users (username, password, first_name, last_name, email, role_id, location_id, is_activated, last_password_reset_date) values ('milan2014', '$2a$10$llkMryD7KBQc1EkOeBdRO.5lcyVR3TEGqXh4G.JadCBu3mdfS44Y.', 'Milan', 'Milanović', 'milan@email.com', 1, 2, true, '2024-11-07 11:30:00');
insert into users (username, password, first_name, last_name, email, role_id, location_id, is_activated, last_password_reset_date) values ('ivana2014', '$2a$10$llkMryD7KBQc1EkOeBdRO.5lcyVR3TEGqXh4G.JadCBu3mdfS44Y.', 'Ivana', 'Ivanović', 'ivana@email.com', 2, 1, true, '2024-11-07 11:30:00');
insert into users (username, password, first_name, last_name, email, role_id, location_id, is_activated, last_password_reset_date) values ('bojan2014', '$2a$10$llkMryD7KBQc1EkOeBdRO.5lcyVR3TEGqXh4G.JadCBu3mdfS44Y.', 'Bojan', 'Bojanović', 'bojan@email.com', 2, 3, false, '2024-11-07 11:30:00');
