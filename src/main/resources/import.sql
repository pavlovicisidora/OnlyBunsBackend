...
insert into users (username, password, first_name, last_name, email, roleId, location_id, is_activated) values ('marko123', 'password123', 'Marko', 'Marković', 'marko@email.com', 2, 1, true);
insert into users (username, password, first_name, last_name, email, roleId, location_id, is_activated) values ('milan2014', 'password456', 'Milan', 'Milanović', 'milan@email.com', 1, 2, true);
insert into users (username, password, first_name, last_name, email, roleId, location_id, is_activated) values ('ivana2014', 'password789', 'Ivana', 'Ivanović', 'ivana@email.com', 2, 1, true);
insert into users (username, password, first_name, last_name, email, roleId, location_id, is_activated) values ('bojan2014', 'password101', 'Bojan', 'Bojanović', 'bojan@email.com', 2, 3, false);
