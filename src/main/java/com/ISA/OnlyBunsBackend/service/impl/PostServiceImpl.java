...
public class PostServiceImpl implements PostService {
 ...
 //   @Cacheable(value = "locationCache")
    ...
    @Override
    public boolean canUserComment(Integer userId){
        return commentRepository.canUserCommentPost(userId);
    }
    ...
    @Override
    public List<PostViewDTO> getAllPostsForMapView(Integer userId) {
        List<Post> posts = postRepository.findAll();
        List<PostViewDTO> postDTOs = new ArrayList<>();
